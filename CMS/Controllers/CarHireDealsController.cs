...
namespace CMS.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class CarHireDealsController : ControllerBase
    {
        private readonly ICarHireDealsService _DealManagementService;
        public CarHireDealsController(ICarHireDealsService DealManagementService) 
        {
        ...
        [HttpGet]
        public async Task<ActionResult> GetAll([FromQuery] CarHireDealFilter filter)
        {
            try
            {
                return Ok(await _DealManagementService.GetCarHireDealManagement(filter));
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public async Task<ActionResult> Create(CreateCarHireDealsModel modal)
        {
            try
            {
                if (modal == null)
        ...
        [HttpPut]
        public async Task<ActionResult> Update(UpdateCarHireModel modal)
        {
            try
            {
                if (modal == null)
