...
namespace CMS.Controllers
{
    ...
    public class SectionContentController : ControllerBase
    {
        ...
        public SectionContentController(ISectionContentService SectionContentService)
        {
        ...
        public async Task<ActionResult> GetById(int Id)
        {
            try
            {
                return Ok(await _SectionContentService.GetById(Id));
            }
            catch (Exception ex)
            {
                Log.Log.Error("Exception: " + ex.ToString(), Log.Log.GetCurrentNameSpace(), Log.Log.GetCurrentClass(), Log.Log.GetCurrentMethod());
        ...
        [HttpPost]
        public async Task<ActionResult> Create(CreateSectionContentModal modal)
        {
            try
            {
                if (modal == null)
                ...
                else
                {
                    ...
                    return Ok(await _SectionContentService.CreateSectionContent(modal));
                }
            }
            catch (Exception ex)
            {
        ...
        [HttpPut]
        public async Task<ActionResult> Update(UpdateSectionContentModal modal)
        {
            try
            {
                if (modal == null)
                ...
                else
                {
                    ...
                    return Ok(await _SectionContentService.UpdateSectionContent(modal));
                }
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> Delete(int Id)
        {
            try
            {
                ...
                {
                    return Ok(await _SectionContentService.SoftDelete(Id));
                }
            }
            catch (Exception ex)
            {
