...
namespace CMS.Repositories.Repositories.HotelAdmin
{
    ...
    {
        private readonly HotelAdminDBContext HotelAdminDBContext;
        public readonly DbSet<T> Entites;
        public Repository(HotelAdminDBContext context)
        {
        ...
        public async Task<T> Insert(T entity)
        {
            try
            {
                ...
                Entites.Add(entity);
                await HotelAdminDBContext.SaveChangesAsync();
            }
            catch (Exception ex)
            {
                throw;
        ...
        public async Task<List<T>> InsertRange(List<T> entities)
        {
            ...
            using (var transaction = await HotelAdminDBContext.Database.BeginTransactionAsync())
            {
                try
                {
