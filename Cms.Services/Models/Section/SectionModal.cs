...
{
    public class SectionModal : EntityModal
    {
        ...
        public virtual SectionTypeModal SectionType { get; set; }
        public virtual TemplateDetailsModal TemplateDetails { get; set; }
        public virtual List<SectionContentModal> SectionContents {  get; set; }
    }
}
