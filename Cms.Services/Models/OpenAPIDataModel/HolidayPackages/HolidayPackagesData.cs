...
namespace Cms.Services.Models.OpenAPIDataModel.HolidayPackages
{
    public class HolidayPackagesData:EntityModal
    {
        /// <summary>
        ...
        public virtual List<HolidayPackagesData> SimilarPackages { get; set; }
        public virtual List<PackageItenariesData> PackageItenaries { get; set; }=new List<PackageItenariesData>();
    }
}
