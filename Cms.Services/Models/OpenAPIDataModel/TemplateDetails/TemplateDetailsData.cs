...
namespace Cms.Services.Models.OpenAPIDataModel.TemplateDetails
{
    public class TemplateDetailsData 
    {
        ...
        public virtual List<TemplateConfigurationData> TemplateConfigurations { get; set; }
        public virtual List<SectionData> Sections { get; set; }

        public virtual List<TemplateDetailsData> SimilarTemplatesData { get; set; }
    }
}
