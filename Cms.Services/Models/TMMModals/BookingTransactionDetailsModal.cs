...
{
    public class BookingTransactionDetailsModal
    {
        ...
        public virtual List<BookingJourneyDetailsModal> BookingJourneyDetails { get; set; }
        public virtual List<BookingPaxDetailsModal> BookingPaxDetails { get; set; }
