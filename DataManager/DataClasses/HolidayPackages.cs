...
namespace DataManager.DataClasses
{
    ...
    public class HolidayPackages : Entity
    {
        /// <summary>
        ...
        [NotMapped]
        public virtual List<HolidayPackages> SimilarPackages { get; set; }
        [NotMapped]
        public virtual List<PackageItenaries> PackageItenaries { get; set; }
